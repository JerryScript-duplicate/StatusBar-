...
public class ColorPickerActivity extends Activity implements
	...
	private WPButtonView mCancelButton;
	private WPButtonView mOkButton;
	...
	private void setUp(int color) {
		...
		mOkButton = (WPButtonView) findViewById(R.id.ok_button);
		mCancelButton = (WPButtonView) findViewById(R.id.cancel_button);
